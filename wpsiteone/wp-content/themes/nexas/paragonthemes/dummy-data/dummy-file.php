 ...
 * @return array Files.
 */
function nexas_import_files() {
    return array(
        array(
            'import_file_name'             =>  esc_html__( 'Theme Demo Content', 'nexas' ),
            'local_import_file'            => trailingslashit( get_template_directory() ) . 'paragonthemes/dummy-data/dummy-data-files/nexas.xml',
            'local_import_widget_file'     => trailingslashit( get_template_directory() ) . 'paragonthemes/dummy-data/dummy-data-files/nexas.wie',
            'local_import_customizer_file' => trailingslashit( get_template_directory() ) . 'paragonthemes/dummy-data/dummy-data-files/nexas.dat',
        ),
    );
}
add_filter( 'pt-ocdi/import_files', 'nexas_import_files' );
...
function nexas_after_import_setup() {
...
add_action( 'pt-ocdi/after_import', 'nexas_after_import_setup' );