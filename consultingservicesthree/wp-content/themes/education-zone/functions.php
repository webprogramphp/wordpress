...
if ( ! defined( 'EDUCATION_ZONE_THEME_VERSION' ) && ! defined( 'EDUCATION_ZONE_THEME_NAME' ) && ! defined( 'EDUCATION_ZONE_THEME_TEXTDOMAIN' ) ) {
	$theme_data = wp_get_theme();	
	define( 'EDUCATION_ZONE_THEME_VERSION', $theme_data->get( 'Version' ) );
    define( 'EDUCATION_ZONE_THEME_NAME', $theme_data->get( 'Name' ) );
    define( 'EDUCATION_ZONE_THEME_TEXTDOMAIN', $theme_data->get( 'TextDomain' ) );
}
